...
draft: false
summary: '아이폰 스냅업체 이아스냅 홈페이지를 기획/디자인/개발/배포한 후기입니다.'
authors: ['default']
layout: PostSimple
---
![iasnap-main-banner](/static/images/iasnap-main.webp)
...
<a href="https://iasnap.vercel.app" target="_blank" rel="noopener noreferrer">이아스냅 홈페이지</a>
</div>
...
<a href="https://github.com/dev-rong/iasnap" target="_blank" rel="noopener noreferrer">이아스냅 GitHub 저장소</a>
</div>
...
호출하여 받아온 데이터를 PageContent 클라이언트 컴포넌트에 프로퍼티로 전달하면 상태 값에 담아
